...
$sql = "select * from enviar_orcamento";
    ...
    <section class="cover-bg-opacity text-left pb_gradient_v1 " id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <form action="envia_aprovarOrcamento.php" method="post" class="bg-white rounded pb_form_v1">
                <h2 class="mb-12 mt-0 text-center">Aprovar</h2>
                <br>
...
<select>
                  ...
                  <option><?php echo "data: " . $row["data_conclusao"]. " - preco: " . $row["preco_total"]."<br>";?> </option>
                  <?php }
                  }?>
              </select>
