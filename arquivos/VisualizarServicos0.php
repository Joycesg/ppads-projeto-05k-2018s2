      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-md-8 relative align-self-center">
              ...
              <form  method="post" class="bg-white rounded pb_form_v1" action="VisualizarServicos.php">
                  <div class="form-group">
                <div class="pb_select-wrap">
                    <h2>Escolha o tipo de serviço que você deseja</h2>
                    <select name ="categoria" class="form-control pb_height-50 reverse">
                    <option value="Categoria Serviço" selected="">Categoria Serviço</option>
