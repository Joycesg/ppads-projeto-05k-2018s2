...
$sql = "INSERT INTO `solicitar_orcamento` (`profissional`, `nome_contato`, `telefone`, `cep`, `endereco`, `numero`, `bairro`, `cidade`, `estado`,`termo`) VALUES 
('".$profissional."','".$contato."','".$telefone."','". $cep."','". $endereco."','". $numero."','". $bairro."','". $cidade."','".$estado."','".$termo."')";
    ...
    <section class="cover-bg-opacity text-left pb_gradient_v1 " id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <form action="ParaSolicitanteDeServico.html" method="post" class="bg-white rounded pb_form_v1">
                <h2 class="mb-12 mt-0 text-center">Orçamento Solicitado</h2>
